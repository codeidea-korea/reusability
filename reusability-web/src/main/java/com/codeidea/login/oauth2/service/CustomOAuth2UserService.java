...
import com.codeidea.login.oauth2.exception.OAuthProviderMissMatchException;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
	...
	private OAuth2User process(OAuth2UserRequest userRequest, OAuth2User user) {
		...
		if (savedUser != null) {
			if (providerType != savedUser.getProviderType()) {
				throw new OAuthProviderMissMatchException("Looks like you're signed up with " + providerType
	...
	private User createUser(OAuth2UserInfo userInfo, ProviderType providerType) {
		...
		User user = new User(userInfo.getId(), userInfo.getName(), userInfo.getEmail(), "Y", userInfo.getImageUrl(),
